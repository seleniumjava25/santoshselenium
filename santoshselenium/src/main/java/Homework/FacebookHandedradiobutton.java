...
public class FacebookHandedradiobutton {
...
//sellect multiple check box
/* try {
 List <WebElement> checkbox= driver.findElements(By.xpath("//input[@id='sex']"));
    System.out.println("the number of check box are:"+checkbox.size());    
...
/*WebElement	submit=driver.findElement(By.xpath("//button[contains(@name,'websubmit')]"));
